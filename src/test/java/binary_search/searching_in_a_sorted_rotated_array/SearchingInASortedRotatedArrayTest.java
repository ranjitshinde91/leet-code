...
class SearchingInASortedRotatedArrayTest {
  ...
  void test1(int[] input, int element, int expected) {
    ...
    var searchingInASortedRotatedArray = new SearchingInASortedRotatedArray();

    int numberOfElementsInIntersection =
        searchingInASortedRotatedArray.searchInSortedRotated(input, element);
